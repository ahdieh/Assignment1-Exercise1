...
public  class PatientTest  {
	...
	public static void main(String[] args) {
		...
		System.out.printf("\" %s %s \" with patient ID #%s, lives in %s , %s ,%s and the postal code is %s.", patient.getFirstName(), patient.getLastName(), patient.getPatientId(), patient.getAddress(), patient.getCity(), patient.getProvince(), patient.getPostalCode());
